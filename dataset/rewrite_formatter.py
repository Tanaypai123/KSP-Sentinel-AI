...
# Split the content at _render
before, rest = content.split("    @staticmethod\n    def _render(brief: InvestigationBrief) -> str:")
_, after = rest.split("    @staticmethod\n    def format_comparison", 1)
...
final = before + new_render + "\n    @staticmethod\n    def format_comparison" + after
